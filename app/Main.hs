-- Written by Malvin Gattinger
-- retrieved from https://github.com/jrclogic/SMCDEL/blob/master/bench/muddychildren.hs
-- modified to work for exp & suc model checkers
